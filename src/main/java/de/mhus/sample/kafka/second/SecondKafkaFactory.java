...
@Service
public class SecondKafkaFactory {

    public static final String SAMPLE_GROUP_ID = "sample-group";
    public static final String SAMPLE_TOPIC_ID = "sample-topic";
    public static final String LISTENER_CONTAINER_FACTORY = "secondKafkaListenerContainerFactory";
    ...
    @Bean
    public KafkaAdmin secondKafkaAdmin() {
    ...
    @Bean
    public NewTopic secondSampleTopic() {
